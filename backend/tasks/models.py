...
class Task(models.Model):
    ...
    task_id = models.AutoField(verbose_name="task_id", primary_key=True)
    data = models.JSONField(null=True, blank=True, verbose_name="task_data")
    project_id = models.ForeignKey(
        Project, verbose_name="project_id", on_delete=models.CASCADE
    )
...
class Annotation(models.Model):
    ...
    task_id = models.ForeignKey(
        Task, on_delete=models.CASCADE, verbose_name="annotation_task_id"
    )
