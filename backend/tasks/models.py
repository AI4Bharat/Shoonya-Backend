...
class Task(models.Model):
    ...
    correct_annotation = models.ForeignKey(
        "Annotation", on_delete=models.RESTRICT, null=True, blank=True, related_name="correct_annotation"
    )

    annotation_users = models.ManyToManyField(
        User, related_name="annotation_users", verbose_name="annotation_users", blank=True
    )
    review_user = models.ManyToManyField(User, related_name="review_users", verbose_name="review_users", blank=True)
