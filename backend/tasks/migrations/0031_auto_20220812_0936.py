    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('unlabeled', 'unlabeled'), ('labeled', 'labeled'), ('skipped', 'skipped'), ('accepted', 'accepted'), ('accepted_with_changes', 'accepted_with_changes'), ('freezed', 'freezed'), ('to_be_revised', 'to_be_revised'), ('draft', 'draft')],
                default='unlabeled', max_length=100, verbose_name='task_status'),
        ), ]
