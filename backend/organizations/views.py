...
class OrganizationViewSet(viewsets.ModelViewSet):
    ...
    def user_analytics(self, request, pk=None):
        ...
        # for reports type supercheck
            ...
            # If no supercheck reports found
            if not final_reports:
                return Response(
        ...
        # for reports type annotation (default)
        else:
            if not (
            ...
            if send_mail == True:
                ...
                for annotator in annotators:
                    ...
                    if (
                        ...
                        temp_result = {
                            ...
                            "Average Segments Per Task": round(
                                avg_segments_per_task, 2
                            ),
                        }
                ...
                if not result:
                    return Response(
                        {
                            "message": "No annotation reports found for the selected criteria"
                        },
                        status=status.HTTP_404_NOT_FOUND,
                    )
