...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('invite_code', models.CharField(max_length=256, null=True, verbose_name='invite_code')),
                ('organization', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invite_oganization', to='organizations.organization', verbose_name='organization')),
                ('users', models.ManyToManyField(related_name='invite_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
