...
class Organization(models.Model):
    ...
    created_by = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='organization', verbose_name='created_by')
...
class Invite(models.Model):
    ...
    users = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='invite_users')

    organization = models.OneToOneField(Organization, on_delete=models.CASCADE, null=True, related_name='invite_oganization', verbose_name='organization')

    invite_code = models.CharField(verbose_name='invite_code', max_length=256, null=True)
