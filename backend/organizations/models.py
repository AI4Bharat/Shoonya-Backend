        ...
        with transaction.atomic():
            for user in users:
                ...
                send_mail(
                    ...
                    f"Hello! You are invited to {organization.title}. Your Invite link is: https://dev.anudesh.ai4bharat.org/#/invite/{invite.invite_code}",
    ...
    def re_invite(cls, users=None):
        with transaction.atomic():
            for user in users:
                ...
                send_mail(
                    "Invitation to join Organization",
                    f"Hello! You are invited to {invite.organization.title}. Your Invite link is: https://dev.anudesh.ai4bharat.org/#/invite/{invite.invite_code}",
                    settings.DEFAULT_FROM_EMAIL,
                    [user.email],
                )
