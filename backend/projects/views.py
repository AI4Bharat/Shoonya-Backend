        ...
        try:
            if (
                ...
                is_translation_project = (
                    True if "translation" in project_type else False
                )
                ...
                for each_user in project_users:
                    ...
                    all_draft_tasks_in_project = Task.objects.filter(
                        Q(project_id=pk)
                        & Q(task_status="draft")
                        & Q(annotation_users=user_id)
                    ).order_by("id")
