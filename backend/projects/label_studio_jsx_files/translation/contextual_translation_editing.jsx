<View>
  ...
  <View style="font-size: large; display: grid; grid-template: auto/1fr 1fr 1fr; column-gap: 1em">
    ...
    <TextArea name="output_text" toName="input_text" value="$machine_translation" rows="5" transcription="false" showSubmitButton="true" maxSubmissions="1" editable="false" required="true"/>
