...
def export_project_in_place(
    ...
    is_AcousticNormalisedTranscriptionEditing = (
        ...
        or project_type == "VerbatimTranscriptionCharacterTagging"
    )
...
def populate_asr_yt(model_language, project__ids=[], stage="l2"):
  ...
  if stage == "l1":
    SERVICE_ID = os.getenv('SERVICE_ID_YT') 
    API_URL = os.getenv('API_URL_YT_1')
    

  DHRUVA_KEY=os.getenv('DHRUVA_KEY_YT')
  MINIO_ACCESS_KEY=os.getenv('MINIO_ACCESS_KEY_YT')
  MINIO_SECRET_KEY=os.getenv('MINIO_SECRET_KEY_YT')
  MINIO_ENDPOINT=os.getenv('MINIO_ENDPOINT_YT')
  MINIO_DIRECTORY=os.getenv('MINIO_DIRECTORY_YT')
...
def populate_asr_try(model_language, project__ids=[], stage="l1"):
  ...
  API_URL = os.getenv('API_URL_N')
  SERVICE_ID =  os.getenv('SERVICE_ID_N')

  if stage == "l2":
    SERVICE_ID = os.getenv('SERVICE_ID_N')
    API_URL = os.getenv('API_URL_N_1')

  DHRUVA_KEY=os.getenv('DHRUVA_KEY_N')
  MINIO_ACCESS_KEY=os.getenv('MINIO_ACCESS_KEY_N')
  MINIO_SECRET_KEY=os.getenv('MINIO_SECRET_KEY_N')
  MINIO_ENDPOINT=os.getenv('MINIO_ENDPOINT_N')
  MINIO_DIRECTORY=os.getenv('MINIO_DIRECTORY_N')
