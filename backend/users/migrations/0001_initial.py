    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, upload_to=users.utils.hash_upload)),
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Annotator'), (2, 'Workspace Manager'), (3, 'Organization Owner')], default=1)),
                ...
                ('invite_accepted', models.BooleanField(default=False, verbose_name='invite_accepted')),
