...
class DatasetInstancePermission(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return request.user.is_authenticated and (request.user.role == User.WORKSPACE_MANAGER or request.user.role == User.ORGANIZATION_OWNER or request.user.is_superuser)
    ...
    def has_object_permission(self, request, view, obj):
        ...
        bool_check = request.user.is_authenticated and (request.user in obj.users.all() or request.user.role == User.ORGANIZATION_OWNER or request.user.is_superuser)
