...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='dataset_type',
            field=models.CharField(choices=[('SentenceText', 'SentenceText'), ('TranslationPair', 'TranslationPair'), ('OCRDocument', 'OCRDocument'), ('BlockText', 'BlockText')], max_length=100, verbose_name='dataset_type'),
        ),
