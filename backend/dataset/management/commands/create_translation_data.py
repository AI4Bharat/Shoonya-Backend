...
for lang in langs:
    ...
    for i, row in tqdm.tqdm(df.iterrows()):
        ...
        t = TranslationPair(input_language=dict_["input_language"], input_text=dict_["input_text"], output_language=dict_["output_language"], machine_translation=dict_["machine_translation"], instance_id=instance_object, parent_data=data_object, context=dict_['context'])
        t.save()
        # rows.append(dict_)
