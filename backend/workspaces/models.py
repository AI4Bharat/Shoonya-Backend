...
class Workspace(models.Model, DummyModelMixin):
    ...
    Workspace model.
    """
    organization = models.ForeignKey(Organization, related_name='organization_workspace', on_delete=models.CASCADE)

    users = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='organization_users')

    workspace_name = models.CharField(verbose_name='workspace_name', max_length=256, null=False)
